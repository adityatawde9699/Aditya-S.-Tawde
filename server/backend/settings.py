...
SECRET_KEY = 'django-insecure-_zb2r7!wq08&%hf88)kw*n7(u@m^mp0*3#f$v@d!t@di@zsxmu'
...
if not all([EMAIL_HOST_USER, EMAIL_HOST_PASSWORD, RECIPIENT_EMAIL]):
    raise ValueError("Email settings are not properly configured. Please check your .env file.")
